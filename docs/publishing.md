...
The **History** tab — every version of an entry, compared and restored — is
[a page of its own](history.md).
...
An entry whose [source language changed](source-language.md#changing-the-language-an-entry-is-written-in)
