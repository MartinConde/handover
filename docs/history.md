...
History controls, relative and exact timestamps, content-language names, diff explanations,
restore confirmations, and retained restore failures are available in English and German. A live
